...
def emotion_tumugi_reimu(emotion: str) -> None:
    """
    霊夢アバターにワンショットアニメーションする関数
    ...
    try:
        logger.info("emotion_tumugi_reimu called")
        ...
        logger.info("emotion_tumugi_reimu finalize")
