...
# ユーザ設定
#-----------------------------------------------------------------
project_dir = "C:\\work\\lambda-tuber\\ai-trial\\mission10"
...
async def main():
    ...
    utility.wiring_agent_tools(mba_list, run_config, run_configs, session)
    ...
    while True:
        ...
        await utility.update_memory(session, starting_agent, run_config)
